...
- в ручную отмечаем результат выполнения:
     - если цель достигнута: присваем цели статус "выполнено", а участникам (ресурсы, местоположения) плюсуем "похвалу" в вашу сторону.
     - в случае провала: присваиваем цели статус "не выполнено", отмечаем причину (не хватило времени, неправильная подготовка, плохое здоровье), а участникам (ресурсы, местоположения) плюсуем "осуждение" в вашу сторону. 
