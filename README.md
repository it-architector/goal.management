...
4. Этап "планирование":
- у каждой цели последовательно отмечайте статус: "ожидание" → "ознакомление" → "установка сроков" → "выполнение" → "сделано".
- в статусе "ознакомление" прописываются оптимальные решения как выполнять цель.
