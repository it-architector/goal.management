...
- сценариев может быть несколько, где у каждого может быть параметр:
     ...
     - строгое выполнение.
- параметр "выполнять до победного" когда срок точно не определён и может влезать во временной промежуток других целей. 
...
- распределяем сценарии цели на временной шкале: 
     ...
     - цикличность: повторять каждые N {годов/месяцев/недель/дней/часов/минут} начиная с промежутка.
