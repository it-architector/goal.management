...
- в ручную отмечаем результат выполнения:
     ...
     - в случае провала: присваиваем цели статус "не выполнено", отмечаем причину (сбой в сценарии, не хватило времени, плохое здоровье), а участникам (ресурсы, местоположения) плюсуем "осуждение" в вашу сторону. 
