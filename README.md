...
- отмечаем результат выполнения ходов действий:
     ...
     - если время вышло и не было выставлено пометок, то выставляется временная пометка "ожидание подтверждения выполнения".
6. **Этап "архив":**
- цели присваем статус "выполнено".
- здесь так же цели со статусами "вредоносное" и "отменена".
