...
4. **Этап "планирование":**
- внимание! от этого этапа зависит благополучный исход.
- целям присвается статус "планирование".
...
- в промежутке между выставленным временем подмечать простой (дни, часы, минуты), так можно увидеть неээфективность используемого времени. если вам нужен покой то должна быть цель уединения.
5. **Этап "выполнение":**
...
6. **Этап "выполнено":**
- целям присвается статус "выполнено".
