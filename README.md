...
4. Этап "планирование":
- отмечайте последовательно у каждой цели "ожидание", "ознакомление" (анализ, сбор данных), "установка сроков", "выполнение", "сделано".
- в случае недоработок возможна реверсия с коментарием в "ожидание".
- у каждой цели ход планирования сохраняется в лог.
5. Этап "список":
